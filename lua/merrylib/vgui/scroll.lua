...
function PANEL:Init()
	...
	self.pnlCanvas:DockPadding(3, 3, 3, 3)
	...
	self.VBar = vgui.Create( "MerryUI.ScrollBar", self )
...
function PANEL:Paint(w, h)
	...
	if (self:GetType() == "base") then
		draw.RoundedBox(8, 0, 0, w, h, theme["p_line"])
	else end 
end
...
vgui.Register("MerryUI.Scroll", PANEL, "DPanel")