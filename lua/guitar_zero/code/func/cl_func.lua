...
local function DrawLoad()
	...
	draw.SimpleTextOutlined(text["Загрузка музыки"], "CloseCaption_Bold", t1_w, t1_h, clr()["t_head"], TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 0, Color(54, 54, 54))
	draw.SimpleTextOutlined(tostring(current_progress) .. "/" .. tostring(end_progress), "CreditsText", t2_w, t2_h, clr()["t_p1"], TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 0, Color(54, 54, 54))
end
